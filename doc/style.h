...
Links to known classes (such as World), functions (such as
example_func()), and files (such as madness.h) are made
automatically.

\todo Need to find a better example class and function for the above examples.
