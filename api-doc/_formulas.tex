...
$ F_{ij} = \langle\psi_i|\hat v_{xc}|\psi_j\rangle $
\pagebreak
...
$ U_{1,x}, U_{1,y}, U_{1,z}, |\mathbf U_1|^2 $
\pagebreak
...
$ n_\alpha=\sum_i w_iF_{i\alpha}^2 $
\pagebreak

$ G_{\alpha,x}=\sum_i w_iF_i\partial_xF_i $
\pagebreak
...
\[ \tau_\sigma = \tfrac12 R^2\left(\sum_i w_i|\nabla F_i|^2
       - 2\,\mathbf U_1\!\cdot\!\mathbf G_\sigma + |\mathbf U_1|^2 n_\sigma\right) \]
\pagebreak

$ \mathbf G_\sigma=\sum_i w_iF_i\nabla F_i $
\pagebreak

\[ \nabla\rho_s = R^2(\nabla n_s - 2\mathbf U_1 n_s) = 2R^2(\mathbf G_s - \mathbf U_1 n_s) \]
\pagebreak
