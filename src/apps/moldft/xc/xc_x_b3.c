/* xc_x_b3.f -- translated by f2c (version 20050501).
...
/* :X_B3subrstart */
/*    Generated: Wed Jan 29 09:08:33 GMT 2003 */
/* Subroutine */ int uks_x_b3__(integer *ideriv, integer *npt, doublereal *
...
/* Computing 2nd power */
		    ...
		    zk[i__] = t5 * -.74442058907928 - t7 * .003024 * sigmaaa /
			     (t10 * .0252 * t11 + 1.) - t19 * .74442058907928 
			    - t21 * .003024 * sigmabb / (t24 * .0252 * t25 + 
			    1.);
		}
/* rhoa,rhob */
	    } else {
...
/* Computing 2nd power */
		    ...
		    t38 = 1 / t37;
		    vrhob[i__] = t2 * -.99256078543904 + t19 * .004032 * 
			    sigmabb * t13 + t6 * .003024 * t24 * (t7 * -.0336 
			    * t19 * t9 - sigmabb * .0336 / t29 / t17 / rhob * 
			    t38);
		    vsigmaaa[i__] = 0.;
		    vsigmaab[i__] = 0.;
		    vsigmabb[i__] = t5 * -.003024 * t13 + t6 * .003024 * t24 *
...
/* Computing 2nd power */
		    ...
		    t38 = 1 / t37;
		    vrhoa[i__] = t2 * -.99256078543904 + t19 * .004032 * 
			    sigmaaa * t13 + t6 * .003024 * t24 * (t7 * -.0336 
			    * t19 * t9 - sigmaaa * .0336 / t29 / t17 / rhoa * 
			    t38);
		    vrhob[i__] = 0.;
		    vsigmaaa[i__] = t5 * -.003024 * t13 + t6 * .003024 * t24 *
			     (.0126 / t7 * t5 * t9 + t34 * .0126 * t38);
		    vsigmaab[i__] = 0.;
		    vsigmabb[i__] = 0.;
		} else {
...
/* Computing 2nd power */
		    ...
		    zk[i__] = t5 * -.74442058907928 - t8 * .003024 * t15 - 
			    t19 * .74442058907928 - t22 * .003024 * t29;
/* Computing 2nd power */
		    d__1 = rhoa;
		    t33 = d__1 * d__1;
		    t35 = 1 / t4 / t33;
...
/* Computing 2nd power */
		    ...
		    t54 = 1 / t53;
		    vrhoa[i__] = t4 * -.99256078543904 + t35 * .004032 * 
			    sigmaaa * t15 + t8 * .003024 * t40 * (t9 * -.0336 
...
/* Computing 2nd power */
		    ...
		    t83 = 1 / t82;
		    vrhob[i__] = t18 * -.99256078543904 + t64 * .004032 * 
			    sigmabb * t29 + t22 * .003024 * t69 * (t23 * 
			    -.0336 * t64 * t25 - sigmabb * .0336 / t74 / t62 /
			     rhob * t83);
		    vsigmaaa[i__] = t7 * -.003024 * t15 + t8 * .003024 * t40 *
			     (.0126 / t9 * t7 * t11 + t50 * .0126 * t54);
		    vsigmaab[i__] = 0.;
		    vsigmabb[i__] = t21 * -.003024 * t29 + t22 * .003024 * 
			    t69 * (.0126 / t23 * t21 * t25 + t79 * .0126 * 
			    t83);
		}
/* rhoa,rhob */
	    } else {
...
/* Computing 2nd power */
		    ...
		    t41 = t7 * -.0336 * t19 * t9 - sigmabb * .0336 / t29 / 
			    t28 * t38;
		    t42 = t24 * t41;
		    vrhob[i__] = t2 * -.99256078543904 + t20 * .004032 * t13 
			    + t6 * .003024 * t42;
		    vsigmaaa[i__] = 0.;
		    vsigmaab[i__] = 0.;
...
/* Computing 2nd power */
		    ...
		    t81 = d__1 * d__1;
		    t87 = 1 / t37 / t36;
		    v2rhob2[i__] = -.3308535951463467 / t29 - t60 * .009408 * 
			    sigmabb * t13 - t20 * .008064 * t42 - t6 * 
			    .006048 * t67 * t68 + t6 * .003024 * t24 * (t7 * 
			    .0784 * t60 * t9 + sigmabb * .168 / t29 / t75 * 
			    t38 - t81 * .0448 / t2 / t75 / t28 * t87);
		    v2sigmaaa2[i__] = 0.;
		    v2sigmaaaab[i__] = 0.;
		    v2sigmaaabb[i__] = 0.;
		    v2sigmaab2[i__] = 0.;
...
/* Computing 2nd power */
		    d__1 = t53;
		    t97 = d__1 * d__1;
		    v2sigmabb2[i__] = t5 * .006048 * t24 * t53 - t6 * .006048 
			    * t67 * t97 + t6 * .003024 * t24 * (-.0063 / t7 / 
...
/* Computing 2nd power */
		    ...
		    t41 = t7 * -.0336 * t19 * t9 - sigmaaa * .0336 / t29 / 
			    t28 * t38;
		    t42 = t24 * t41;
		    vrhoa[i__] = t2 * -.99256078543904 + t20 * .004032 * t13 
			    + t6 * .003024 * t42;
		    vrhob[i__] = 0.;
		    t53 = .0126 / t7 * t5 * t9 + t34 * .0126 * t38;
		    vsigmaaa[i__] = t5 * -.003024 * t13 + t6 * .003024 * t24 *
...
/* Computing 2nd power */
		    ...
		    t81 = d__1 * d__1;
		    t87 = 1 / t37 / t36;
		    v2rhoa2[i__] = -.3308535951463467 / t29 - t60 * .009408 * 
			    sigmaaa * t13 - t20 * .008064 * t42 - t6 * 
			    .006048 * t67 * t68 + t6 * .003024 * t24 * (t7 * 
			    .0784 * t60 * t9 + sigmaaa * .168 / t29 / t75 * 
			    t38 - t81 * .0448 / t2 / t75 / t28 * t87);
		    v2rhob2[i__] = 0.;
		    v2rhoab[i__] = 0.;
/* Computing 2nd power */
		    d__1 = t53;
		    t97 = d__1 * d__1;
		    v2sigmaaa2[i__] = t5 * .006048 * t24 * t53 - t6 * .006048 
			    * t67 * t97 + t6 * .003024 * t24 * (-.0063 / t7 / 
...
/* Computing 2nd power */
		    ...
		    t57 = t9 * -.0336 * t35 * t11 - sigmaaa * .0336 * t47 * 
			    t54;
		    t58 = t40 * t57;
		    vrhoa[i__] = t4 * -.99256078543904 + t36 * .004032 * t15 
			    + t8 * .003024 * t58;
/* Computing 2nd power */
		    d__1 = rhob;
		    t62 = d__1 * d__1;
...
/* Computing 2nd power */
		    ...
		    t86 = t23 * -.0336 * t64 * t25 - sigmabb * .0336 * t76 * 
			    t83;
		    t87 = t69 * t86;
		    vrhob[i__] = t18 * -.99256078543904 + t65 * .004032 * t29 
			    + t22 * .003024 * t87;
		    t92 = 1 / t9;
		    t98 = t92 * .0126 * t7 * t11 + t50 * .0126 * t54;
		    t99 = t40 * t98;
		    vsigmaaa[i__] = t7 * -.003024 * t15 + t8 * .003024 * t99;
		    vsigmaab[i__] = 0.;
		    t104 = 1 / t23;
...
/* Computing 2nd power */
		    ...
		    t138 = d__1 * d__1;
		    t144 = 1 / t53 / t52;
		    v2rhoa2[i__] = -.3308535951463467 / t45 - t117 * .009408 *
			     sigmaaa * t15 - t36 * .008064 * t58 - t8 * 
			    .006048 * t124 * t125 + t8 * .003024 * t40 * (t9 *
			     .0784 * t117 * t11 + sigmaaa * .168 / t45 / t132 
			    * t54 - t138 * .0448 / t4 / t132 / t44 * t144);
		    t154 = 1 / t18 / t73;
		    t161 = 1 / t68 / t28;
/* Computing 2nd power */
		    d__1 = t86;
...
/* Computing 2nd power */
		    ...
		    t175 = d__1 * d__1;
		    t181 = 1 / t82 / t81;
		    v2rhob2[i__] = -.3308535951463467 / t74 - t154 * .009408 *
			     sigmabb * t29 - t65 * .008064 * t87 - t22 * 
			    .006048 * t161 * t162 + t22 * .003024 * t69 * (
			    t23 * .0784 * t154 * t25 + sigmabb * .168 / t74 / 
			    t169 * t83 - t175 * .0448 / t18 / t169 / t73 * 
			    t181);
		    v2rhoab[i__] = 0.;
		    t192 = t7 * t40;
		    v2rhoasigmaaa[i__] = t35 * .004032 * t15 - t36 * .004032 *
			     t99 + t192 * .003024 * t57 - t8 * .006048 * t124 
			    * t57 * t98 + t8 * .003024 * t40 * (t92 * -.0168 *
		    ...
		    v2rhobsigmaab[i__] = 0.;
		    t218 = t21 * t69;
		    v2rhobsigmabb[i__] = t64 * .004032 * t29 - t65 * .004032 *
			     t111 + t218 * .003024 * t86 - t22 * .006048 * 
			    t161 * t86 * t110 + t22 * .003024 * t69 * (t104 * 
			    -.0168 * t64 * t25 - t76 * .0504 * t83 + sigmabb *
			     .0168 / t18 / t169 / t62 * t181);
/* Computing 2nd power */
		    d__1 = t98;
		    t242 = d__1 * d__1;
		    v2sigmaaa2[i__] = t192 * .006048 * t98 - t8 * .006048 * 
			    t124 * t242 + t8 * .003024 * t40 * (-.0063 / t9 / 
			    sigmaaa * t7 * t11 + .0063 / sigmaaa * t50 * t54 
			    - .0063 / t4 / t132 / rhoa * t144);
		    v2sigmaaaab[i__] = 0.;
		    v2sigmaaabb[i__] = 0.;
		    v2sigmaab2[i__] = 0.;
		    v2sigmaabbb[i__] = 0.;
/* Computing 2nd power */
		    d__1 = t110;
		    t266 = d__1 * d__1;
		    v2sigmabb2[i__] = t218 * .006048 * t110 - t22 * .006048 * 
			    t161 * t266 + t22 * .003024 * t69 * (-.0063 / t23 
			    / sigmabb * t21 * t25 + .0063 / sigmabb * t79 * 
			    t83 - .0063 / t18 / t169 / rhob * t181);
		}
/* rhoa,rhob */
	    } else {
/* rho */
...
/* Subroutine */ int rks_x_b3__(integer *ideriv, integer *npt, doublereal *
...
/* Computing 2nd power */
		...
		t40 = 1 / t39;
		vrhoa[i__] = t2 * -.7877960174741572 + t20 * 
			.005080001673176129 * sigma * t14 + t6 * 
			.001905000627441048 * t25 * (t7 * -.08466669455293548 
			* t20 * t10 - sigma * .106673350692263 / t30 / t18 / 
			rho * t40);
		vsigmaaa[i__] = t5 * -.01524000501952839 * t14 + t6 * 
			.003810001254882096 * t25 * (.06350002091470161 / t7 *
...
/* Computing 2nd power */
		...
		t44 = t25 * t43;
		vrhoa[i__] = t2 * -.7877960174741572 + t21 * 
...
/* Computing 2nd power */
		...
		t83 = d__1 * d__1;
		t89 = 1 / t39 / t38;
		v2rhoa2[i__] = -.5251973449827715 / t30 - t62 * 
			.02370667447482193 * sigma * t14 - t21 * 
			.01016000334635226 * t44 - t6 * .003810001254882096 * 
			t69 * t70 + t6 * .001905000627441048 * t25 * (t7 * 
			.3951112412470322 * t62 * t10 + sigma * 
			1.06673350692263 / t30 / t77 * t40 - t83 * 
			.4515557042823225 / t2 / t77 / t29 * t89);
		t100 = t5 * t25;
		v2rhoasigmaaa[i__] = t20 * .02032000669270451 * t14 - t21 * 
			.005080001673176129 * t56 + t100 * 
			.007620002509764193 * t43 - t6 * .003810001254882096 *
			 t69 * t43 * t55 + t6 * .001905000627441048 * t25 * (
			t49 * -.169333389105871 * t20 * t10 - t32 * 
			.640040104153578 * t40 + sigma * .3386667782117419 / 
			t2 / t77 / t18 * t89);
/* Computing 2nd power */
		d__1 = t55;
		t124 = d__1 * d__1;
		v2sigmaaa2[i__] = t100 * .03048001003905677 * t55 - t6 * 
			.007620002509764193 * t69 * t124 + t6 * 
			.003810001254882096 * t25 * (-.1270000418294032 / t7 /
