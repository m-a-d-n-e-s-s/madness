...
std::vector<std::vector<real_function_3d>> madness::operator-(const std::vector<std::vector<real_function_3d>> a,
...
// Multiplication of a vector of vectors by a scalar g[i][j] = a[i][j] * b(i)
std::vector<std::vector<real_function_3d>> madness::operator*(std::vector<std::vector<real_function_3d>> a,
                                                              double b)
{
   MADNESS_ASSERT(a.size() > 0);
   MADNESS_ASSERT(a[0].size() > 0);   
...
void madness::operator+=(std::vector<std::vector<real_function_3d>> & a,
                         std::vector<std::vector<real_function_3d>> b)
{
   MADNESS_ASSERT(a.size() > 0);
   MADNESS_ASSERT(a.size() == b.size()); 
...
double madness::inner(std::vector<std::vector<real_function_3d>> a,
                      std::vector<std::vector<real_function_3d>> b)
{
   MADNESS_ASSERT(a.size() > 0);
   MADNESS_ASSERT(a.size() == b.size());
