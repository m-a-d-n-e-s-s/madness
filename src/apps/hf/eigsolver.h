...
public:
  ...
  virtual funcT op_o(const std::vector<funcT>& phis, const funcT& psi) = 0;
  //*************************************************************************

  //*************************************************************************
  // Density-dependent portion of operator
  virtual funcT op_r(const funcT& rho, const funcT& psi) = 0;
  //*************************************************************************
...
public:
  ...
  EigSolver(World& world, std::vector<double> eigs, funcT rho, 
      std::vector<EigSolverOp*> ops, double thresh); 
  //*************************************************************************
