...
struct ResponseParameters : public QCCalculationParametersBase {
  ...
  ResponseParameters() {
    ...
    initialize<bool>("plot_range", false,
                     "controls which orbitals will be plotted");
    initialize<std::vector<int>>("plot_data", std::vector<int>{0},
                                 "Orbitals to plot");
    ...
    initialize<std::string>("restart_file", "none",
                            "file to read ground parameters from");
    initialize<bool>("kain", false,
    ...
    initialize<std::string>("save_file", "none",
                            "File name to save orbitals for restart");
    initialize<bool>("save_density", false,
 ...
 public:
  ...
  [[nodiscard]] std::string perturbation() const {
    return get<std::string>("perturbation");
  }
  ...
  [[nodiscard]] std::string calc_type() const {
    return get<std::string>("calc_type");
  }
  ...
  [[nodiscard]] size_t num_orbitals() const {
    return get<size_t>("num_orbitals");
  }
  ...
  [[nodiscard]] bool plot_all_orbitals() const {
    return get<bool>("plot_all_orbitals");
  }
  ...
  [[nodiscard]] std::vector<double> protocol() const {
    return get<std::vector<double>>("protocol");
  }
  [[nodiscard]] size_t larger_subspace() const {
    return get<size_t>("larger_subspace");
  }
  [[nodiscard]] int k() const { return get<int>("k"); }
  [[nodiscard]] bool random() const { return get<bool>("random"); }
  [[nodiscard]] bool store_potential() const {
    return get<bool>("store_potential");
  }
  [[nodiscard]] vector<double> freq_range() const {
    return get<vector<double>>("freq_range");
  }
  ...
  [[nodiscard]] std::string restart_file() const {
    return get<std::string>("restart_file");
  }
  ...
  [[nodiscard]] std::string save_file() const {
    return get<std::string>("save_file");
  }
  [[nodiscard]] size_t guess_max_iter() const {
    return get<size_t>("guess_max_iter");
  }
  [[nodiscard]] bool property() const { return get<bool>("property"); }
  [[nodiscard]] int loadbalparts() const { return get<int>("loadbalparts"); }
  [[nodiscard]] bool excited_state() const {
    return get<bool>("excited_state");
  }
  ...
  [[nodiscard]] std::string d2_types() const {
    return get<std::string>("d2_types");
  }
  [[nodiscard]] double omega() const { return get<double>("omega"); }
  [[nodiscard]] double L() const { return get<double>("l"); }
  [[nodiscard]] bool spinrestricted() const {
    return get<bool>("spinrestricted");
  }
  void set_ground_state_calculation_data(
    ...
    set_derived_value<double>("lo",
                              g_params.molecule().smallest_length_scale());
