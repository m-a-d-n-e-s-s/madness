...
struct moldftSchema {
    ...
    moldftSchema(World &world, std::string molecule_name, std::string m_xc, const runSchema &schema) : mol_name(std::move(molecule_name)), xc(std::move(m_xc)) {
...
struct frequencySchema {
    ...
    frequencySchema(World &world, const runSchema &run_schema, const moldftSchema &m_schema, std::string r_operator, bool static_calc);
...
frequencySchema::frequencySchema(World &world, const runSchema &run_schema, const moldftSchema &m_schema, std::string r_operator, bool static_calc)
