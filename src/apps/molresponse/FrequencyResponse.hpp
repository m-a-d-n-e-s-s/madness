...
class QuadraticResponse : public ResponseBase {
 ...
 public:
  ...
  std::pair<Tensor<double>, std::vector<std::string>> compute_beta_v2(
      World& world, const double& omega_b, const double& omega_c);
 ...
 private:
  ...
  X_space compute_coulomb_term(World& world, const X_space& A, const X_space& B,
                               const X_space& D) const;
  X_space compute_exchange_term(World& world, const X_space& A,
                                const X_space& B, const X_space& x_apply) const;
  std::tuple<X_space, X_space, X_space, X_space> compute_zeta_response_vectors(
      World& world, const X_space& B, const X_space& C);
  std::pair<X_space, X_space> compute_first_order_fock_matrix_terms(
      World& world, const X_space& A, const X_space& phi0,
  ...
  std::pair<Tensor<double>, std::vector<std::string>> compute_beta_tensor(
      World& world, const X_space& AB_left, const X_space& AB_right,
      const X_space& BA_left, const X_space& BA_right, const X_space& XA,
      const X_space& VBC);
