...
private:
    ...
    X_space bsh_update_response(World& world, X_space& theta_X, vector<poperatorT>& bsh_x_ops,
                                ...
                                double& x_shifts);
    void update(World& world, X_space& Chi, X_space& res, XCOperator<double, 3>& xc,
                vector<poperatorT>& bsh_x_ops, vector<poperatorT>& bsh_y_ops,
    ...
    std::tuple<X_space, X_space, residuals> update(
