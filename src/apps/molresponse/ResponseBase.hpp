...
public:
    ...
    virtual vector_real_function_3d compute_density(World &world, const X_space &x, const vector_real_function_3d &phi0, const vector_real_function_3d &rho1,
                                                    bool update) const = 0;
};

class StaticDensityStrategy : public ComputeDensityStrategy {
public:
    vector_real_function_3d compute_density(World &world, const X_space &x, const vector_real_function_3d &phi0, const vector_real_function_3d &rho1,
...
public:
    ...
    virtual X_space compute_VXC1(World &world, const X_space &x, const vector_real_function_3d &rho1,
                                 const std::pair<vector_real_function_3d, vector_real_function_3d> &phi0, const XCOperator<double, 3> &xc) const = 0;
};
...
public:
    X_space compute_VXC1(World &world, const X_space &x, const vector_real_function_3d &rho1,
                         const std::pair<vector_real_function_3d, vector_real_function_3d> &phi0, const XCOperator<double, 3> &xc) const override {
...
public:
    ...
    virtual X_space compute_J1(World &world, const X_space &x, const vector_real_function_3d &rho1,
                               const std::pair<vector_real_function_3d, vector_real_function_3d> &phi0, const poperatorT &coulomb_ops) const = 0;
};

class J1StrategyFull : public J1Strategy {
public:
    X_space compute_J1(World &world, const X_space &x, const vector_real_function_3d &rho1,
                       const std::pair<vector_real_function_3d, vector_real_function_3d> &phi0, const poperatorT &coulomb_ops) const override {
...
public:
    explicit Context(std::unique_ptr<inner_strategy> &&innerStrategy = {}, std::unique_ptr<J1Strategy> &&j1Strategy = {},
                     std::unique_ptr<K1Strategy> &&k1Strategy = {}, std::unique_ptr<VXC1Strategy> &&vxc1trategy = {},
                     std::unique_ptr<ComputeDensityStrategy> &&densityStrategy = {}, std::unique_ptr<LoadXSpaceStrategy> &&loadXSpaceStrategy = {})
        : inner_strategy_(std::move(innerStrategy)), j1_strategy_(std::move(j1Strategy)), k1_strategy_(std::move(k1Strategy)),
          vxc1_strategy_(std::move(vxc1trategy)), density_strategy_(std::move(densityStrategy)), load_x_space_strategy_(std::move(loadXSpaceStrategy)) {}
    void set_strategy(std::unique_ptr<inner_strategy> &&strategy, std::unique_ptr<J1Strategy> &&j1Strategy, std::unique_ptr<K1Strategy> &&K1Strategy,
                      std::unique_ptr<VXC1Strategy> &&vxc1Strategy, std::unique_ptr<ComputeDensityStrategy> &&densityStrategy,
                      std::unique_ptr<LoadXSpaceStrategy> &&loadXSpaceStrategy, const ResponseParameters &r_params) {
    ...
    X_space compute_j1(World &world, const X_space &x, const vector_real_function_3d &rho1, const double_response_vector &phi0,
    ...
    X_space compute_VXC1(World &world, const X_space &x, const vector_real_function_3d &rho1, const double_response_vector &phi0,
...
protected:
    ...
    void x_space_step_restriction(World &world, const X_space &old_Chi, X_space &temp, bool restrict_y, const double &max_bsh_rotation);
...
#undef MADCHEM_HAS_STD_FILESYSTEM
    ...
    void plotResponseOrbitals(World &world, size_t iteration, const response_space &x_response, const response_space &y_response,
                              const ResponseParameters &responseParameters, const GroundStateCalculation &g_params);
    ...
    auto compute_theta_X(World &world, const X_space &chi, const vector_real_function_3d &rho1, const XCOperator<double, 3> &xc,
    ...
    auto update_residual(World &world, const X_space &chi, const X_space &g_chi, const std::string &calc_type, const Tensor<double> &old_residuals,
                         const X_space &xres_old) -> residuals;

    auto compute_response_potentials(World &world, const X_space &chi, XCOperator<double, 3> &xc, const std::string &calc_type) const
    ...
    void function_data_to_json(json &j_mol_in, size_t iter, const Tensor<double> &x_norms, const Tensor<double> &x_abs_norms, const Tensor<double> &rho_norms,
