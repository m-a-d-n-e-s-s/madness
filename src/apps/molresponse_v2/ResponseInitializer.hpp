...
inline ResponseVector initialize_guess_vector(World &world, const GroundStateData &gs,
  ...
  vector_real_function_3d Vp = zero_functions_compressed<double, 3>(world, num_orbitals);
