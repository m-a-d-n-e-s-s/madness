                           ...
                           const double k_fq)
{
    ...
    truncate2(world, dpsi_qu_dx, dpsi_qd_dz, prec);
    world.gop.fence();
    ...
    truncate2(world, dpsi_qu_dy, dpsi_qd_dx, prec);
    world.gop.fence();
    ...
    truncate2(world, dpsi_qu_dz, dpsi_qd_dx, prec);
    ...
    dpsi_qu_dz.clear(); dpsi_qd_dz.clear(); W_q.clear(); B_q.clear();
    world.gop.fence();
