...
namespace fuset {
	...
	vector<PrimitiveOp<Type>*> _sequence;
	vector<const KaryTree<Type>*> _trees;
	vector<ValidOpDag> _validOpDags;
	vector<vector<int> > _operandTrees;	

	FusedOpSequence(vector<PrimitiveOp<Type>*> sequence, vector<const KaryTree<Type>*> trees){
	    _sequence = sequence;
	    _trees = trees;
	}
    };
    ...
    template<typename Type>
	class FuseT{
	typedef DependencyInfo<Type> DInfo;
    private:
	...
	FuseT(vector<PrimitiveOp<Type>*> sequence){
	    _sequence = sequence;
	...
	FusedOpSequence<Type> getFusedOpSequence();
    ...
    template<typename Type>
	FusedOpSequence<Type> FuseT<Type>::getFusedOpSequence(){

	//set _sequence and _trees
	FusedOpSequence<Type> temp(_sequence,_trees);
    ...
    template<typename Type>
	void FuseT<Type>::addPreOps(int opIndex, int validOpDagID){
    ...
    template<typename Type>
	void FuseT<Type>::addPostOps(int opIndex, int validOpDagID){
...
//		    source.push_back(op);
    ...
    template<typename Type>
	void FuseT<Type>::getValidOpDAGSequence(){
    ...
    template<typename Type>
	void FuseT<Type>::printValidSequences(){
	...
	for(int i =0; i< _validOpDAGs.size(); i++)
        ...
        template<typename Type>
	void FuseT<Type>::printOpsAndTrees(){
	    if(!_isSequenceProcessed){
		cout<<"Sequence not processed!"<<endl;
		return;
	    }
	    ...
	    for(int i =0; i<_numOps; i++)
		cout<<i<<" "<<_sequence[i]->_opName<<" OpID : "<<_sequence[i]->_OpID<<" TreeID :"<<_trees[i]->_treeID<<" TreeName : "<<_trees[i]->_treeName<< endl;
	    cout<<"________________________"<<endl;
	    cout<<"________________________"<<endl;
	    cout<<endl<<"Source Trees "<<endl<<endl;
	    for(int i =_numOps; i<_trees.size(); i++)
		cout<<i<<" "<<" TreeID :"<<_trees[i]->_treeID<<" TreeName : "<<_trees[i]->_treeName<< endl;
	    cout<<"________________________"<<endl;
	    cout<<"________________________"<<endl;
