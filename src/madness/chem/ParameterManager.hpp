...
struct OptimizationParameters : public QCCalculationParametersBase
{
  ...
  OptimizationParameters(World& world, const commandlineparser& parser) : OptimizationParameters()
  {
  ...
  [[nodiscard]] int get_maxiter() const
  {
    return get<int>("maxiter");
  }
