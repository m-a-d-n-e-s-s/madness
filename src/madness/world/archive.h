...
#define ARCHIVE_REGISTER_TYPE_AND_PTR_NAMES(T) \
        ...
        typename std::enable_if< is_trivially_serializable<T>::value && is_output_archive<Archive>::value >::type
        ...
        template <class Archive, class T>
        typename std::enable_if< is_trivially_serializable<T>::value && is_input_archive<Archive>::value >::type
        serialize(const Archive& ar, const T* t, unsigned int n) {
        ...
        /// \param[in] n Number of data items to be serialized.
        template <class Archive, class T>
        typename std::enable_if< ! is_trivially_serializable<T>::value && is_archive<Archive>::value >::type
        serialize(const Archive& ar, const T* t, unsigned int n) {
        ...
        struct ArchiveStoreImpl< Archive, std::vector<T> > {
            ...
            template <typename U = T, typename = std::enable_if_t<is_trivially_serializable<U>::value>>
            ...
            static inline void store(const Archive& ar, const std::vector<U>& v, std::enable_if_t<!is_trivially_serializable<U>::value>* = nullptr) {
        ...
        struct ArchiveLoadImpl< Archive, std::vector<T> > {
            ...
            /// \param[out] v The \c vector.
            template <typename U = T>
            static void load(const Archive& ar, std::vector<U>& v, std::enable_if_t<!is_trivially_serializable<U>::value>* = nullptr) {
