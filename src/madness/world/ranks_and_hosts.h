...
namespace madness {
    ...
    static std::map<std::string,std::vector<long>> ranks_per_host(World& universe) {
    ...
    static long lowest_rank_on_host_of_rank(const std::map<std::string,std::vector<long>> ranks_per_host1, int rank) {
     ...
     */
    static std::vector<long> unique_ranks_per_host(World& world, const std::map<std::string,std::vector<long>> ranks_per_host1) {
