...
int main(int argc, char**argv) {
    ...
    try {
        ...
        */
        ...
        test_basic<double,4>(world);
         
        //test_basic<double,5>(world);
        /*
        test_conv<double,4>(world);
        test_math<double,4>(world);
        test_diff<double,4>(world);
        test_op<double,4>(world);
        test_coulomb(world);
        test_plot<double,4>(world);
        test_io<double,4>(world);
        */
