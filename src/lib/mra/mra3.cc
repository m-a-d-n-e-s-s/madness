...
namespace madness {
  ...
  template Tensor<std::complex<double> > fcube<std::complex<double>, 3>(Key<3> const&, std::complex<double> (*)(Vector<double, 3> const&), Tensor<double> const&);
    ...
    volatile std::list<detail::PendingMsg> WorldObject<FunctionImpl<double,3> >::pending;
    Spinlock WorldObject<FunctionImpl<double,3> >::pending_mutex;
    volatile std::list<detail::PendingMsg> WorldObject<madness::FunctionImpl<std::complex<double>, 3> >::pending;
    Spinlock WorldObject<FunctionImpl<std::complex<double>, 3> >::pending_mutex;

    volatile std::list<detail::PendingMsg> WorldObject<WorldContainerImpl<Key<3>, FunctionNode<double, 3>, Hash<Key<3> > > >::pending;
    Spinlock WorldObject<WorldContainerImpl<Key<3>, FunctionNode<double, 3>, Hash<Key<3> > > >::pending_mutex;
    volatile std::list<detail::PendingMsg> WorldObject<WorldContainerImpl<Key<3>, FunctionNode<std::complex<double>, 3>, Hash<Key<3> > > >::pending;
    Spinlock WorldObject<WorldContainerImpl<Key<3>, FunctionNode<std::complex<double>, 3>, Hash<Key<3> > > >::pending_mutex;

    volatile std::list<detail::PendingMsg> WorldObject<DerivativeBase<double,3> >::pending;
    Spinlock WorldObject<DerivativeBase<double,3> >::pending_mutex;
    volatile std::list<detail::PendingMsg> WorldObject<DerivativeBase<std::complex<double>,3> >::pending;
    Spinlock WorldObject<DerivativeBase<std::complex<double>,3> >::pending_mutex;
