...
namespace madness {
    ...
    SteepestDescent::SteepestDescent(const SharedPtr<OptimizationTargetInterface>& target,
                                     double tol,
    ...
    QuasiNewton::QuasiNewton(const SharedPtr<OptimizationTargetInterface>& target,
                             double tol,
                             double value_precision,
                             double gradient_precision) 
        : update("BFGS")
