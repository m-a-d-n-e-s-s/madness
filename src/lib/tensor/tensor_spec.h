...
template Tensor<double>& fast_transform(const Tensor<double>& t, const Tensor<double>& c, Tensor<double>& result, Tensor<double>& work);
...
template Tensor<float>& fast_transform(const Tensor<float>& t, const Tensor<float>& c, Tensor<float>& result, Tensor<float>& work);
...
template Tensor<double_complex>& fast_transform(const Tensor<double_complex>& t, const Tensor<double_complex>& c, Tensor<double_complex>& result, Tensor<double_complex>& work);
...
template Tensor<double_complex>& fast_transform(const Tensor<double_complex>& t, const Tensor<double>& c, Tensor<double_complex>& result, Tensor<double_complex>& work);
...
template Tensor<float_complex>& fast_transform(const Tensor<float_complex>& t, const Tensor<float_complex>& c, Tensor<float_complex>& result, Tensor<float_complex>& work);
...
template Tensor<float_complex>& fast_transform(const Tensor<float_complex>& t, const Tensor<float>& c, Tensor<float_complex>& result, Tensor<float_complex>& work);
