...
#ifndef MADNESS_WORLD_TR1_MEMORY_H__INCLUDED
#define MADNESS_WORLD_TR1_MEMORY_H__INCLUDED

/// \file sharedptr.h
/// \brief Includes TR1 shared_ptr. It imports all TR1 type traits into the
/// std namespace. It also includes make_shared and allocate_shared helper
/// functions which are a part of the current C++0x draft.
...
#endif // MADNESS_WORLD_TR1_MEMORY_H__INCLUDED
