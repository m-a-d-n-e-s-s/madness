...
int main(int argc, char **argv) {
    ...
    auto volume_functor = std::make_shared<MolecularVolumeMask>(sigma, atomic_radii, atomic_coords);
    auto gradx_functor = std::make_shared<MolecularVolumeMaskGrad>(sigma, atomic_radii, atomic_coords, 0);
    auto grady_functor = std::make_shared<MolecularVolumeMaskGrad>(sigma, atomic_radii, atomic_coords, 1);
    auto gradz_functor = std::make_shared<MolecularVolumeMaskGrad>(sigma, atomic_radii, atomic_coords, 2);
    auto surface_functor = std::make_shared<MolecularSurface>(sigma, atomic_radii, atomic_coords);
