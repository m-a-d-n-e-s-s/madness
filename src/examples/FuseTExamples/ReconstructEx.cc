...
int main(int argc, char** argv) 
{
	...
	u0.compress();
	printf ("======================================\n");
	printf ("After u0 is compressed by MADNESS\n");
	

	printf ("======================================\n");
	printf ("Before u0 is reconstructed\n");

    //NothingOp<double,3> op1("Nothing",&result,&u0);
	...
	printf ("======================================\n");
	printf ("After u0 is reconstructed\n");
...
//	exe.execute(&op3, false);
	...
	//printf ("Try to re-run the compress operation\n");
