...
static double alpha_func_rand(const coord_3d& r) {
	const double x=r[0], y=r[1], z=r[2];
	return ( (2*x*x + 3*y*y + 4*z*z) * sin(x*x + y*y + z*z) );
};
...
//
	...
	sequence.push_back(&op_compress_f_0);	
	sequence.push_back(&op_compress_f_1);	
	sequence.push_back(&op_compress_f_2);	
	sequence.push_back(&op_compress_g_0);	
	sequence.push_back(&op_compress_g_1);	
	sequence.push_back(&op_compress_g_2);

	sequence.push_back(&op_inner_f_g_0_0);
	sequence.push_back(&op_inner_f_g_0_1);
	sequence.push_back(&op_inner_f_g_0_2);
	sequence.push_back(&op_inner_f_g_1_0);
	sequence.push_back(&op_inner_f_g_1_1);
	sequence.push_back(&op_inner_f_g_1_2);
	sequence.push_back(&op_inner_f_g_2_0);
	sequence.push_back(&op_inner_f_g_2_1);
	sequence.push_back(&op_inner_f_g_2_2);
	
	op_inner_f_g_0_0._sum = 0.0;
	op_inner_f_g_0_1._sum = 0.0;
	op_inner_f_g_0_2._sum = 0.0;
	op_inner_f_g_1_0._sum = 0.0;
	op_inner_f_g_1_1._sum = 0.0;
	op_inner_f_g_1_2._sum = 0.0;
	op_inner_f_g_2_0._sum = 0.0;
	op_inner_f_g_2_1._sum = 0.0;
	op_inner_f_g_2_2._sum = 0.0;
