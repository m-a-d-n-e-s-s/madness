  ...
  foreach(_dep ${_dep_mad_comp})
    ...
    if(TARGET ${_dep})
        ...
        if (_dep_interface_compile_definitions)
          target_compile_definitions(MAD${_name} PUBLIC ${_dep_interface_compile_definitions})
        endif()
        ...
        if (_dep_interface_include_directories)
          target_include_directories(MAD${_name} PUBLIC ${_dep_interface_include_directories})
        endif()
        get_target_property(_dep_interface_compile_options ${_dep} INTERFACE_COMPILE_OPTIONS)
        if (_dep_interface_compile_options)
          target_compile_options(MAD${_name} PUBLIC ${_dep_interface_compile_options})
        endif()
